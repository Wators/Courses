...
//console.log("Objet Existant"); 
    ...
    callback({'tts' : "L'élément :" + xml.item + ", est deja present dans la liste de course"}); // retourne Objet existant 
...
new_jsonStr = JSON.stringify(objet);
   ...
   callback({'tts' : "je rajoute : " + xml.item + "à la liste"});
 });
...
// vide la liste des courses
	...
	callback({'tts' : "je vide la liste des courses"});
